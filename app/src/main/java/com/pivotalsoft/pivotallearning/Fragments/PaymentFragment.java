...
import com.pivotalsoft.pivotallearning.Adapters.PaymentAdapter;
...
public class PaymentFragment extends Fragment {
    ...
    private PaymentAdapter batchesAdapter;
    private List<PaymentAnalaticItem> batchesItemList= new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ULR = Apis.ADD_PAYMENT_URL+"/"+regno;
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    JSONArray jsonArray1 = response.optJSONArray("paymentdata");
                    ...
                    for (int i = 0; i < jsonArray1.length(); i++) {
                        ...
                        String paiddate = jsonObject.optString("paiddate").toString();
                        ...
                        String amountdue = jsonObject.optString("amountdue").toString();
                        String duedate = jsonObject.optString("duedate").toString();
                        String remarks = jsonObject.optString("remarks").toString();
                       // String collectedby = jsonObject.optString("collectedby").toString();
                        ...
                        String staffid = jsonObject.optString("staffid").toString();
                                ...
                                batchesItemList.add(new PaymentAnalaticItem(receiptno,paiddate, regno, batchid, amountpaid, amountdue,duedate, remarks, fullname,mobile,batchcode,coursename,staffid));

                                batchesAdapter = new PaymentAdapter(getContext(), batchesItemList);
