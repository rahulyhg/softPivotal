...
import com.pivotalsoft.pivotallearning.Adapters.WorksAdapter;
...
public class WorksFragment extends Fragment {
    ...
    private WorksAdapter batchesAdapter;
    private List<WorkItem> batchesItemList= new ArrayList<>();
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    JSONArray jsonArray1 = response.optJSONArray("studentworksdata");
                    ...
                    for (int i = 0; i < jsonArray1.length(); i++) {
                        ...
                        String workid = jsonObject.optString("workid").toString();
                        ...
                        String actualscore = jsonObject.optString("actualscore").toString();
                        String givenscore = jsonObject.optString("givenscore").toString();

                        batchesItemList.add(new WorkItem(workid,regno1, batchid, title, description,startdate, enddate, actualscore,givenscore));

                        batchesAdapter = new WorksAdapter(getContext(), batchesItemList);
