...
public class NewCoursesAdapter  extends RecyclerView.Adapter<NewCoursesAdapter.MyViewHolder> {

    private Context mContext;
    private List<NewCourseItem> coursesItemList;
    ...
    public NewCoursesAdapter(Context mContext, List<NewCourseItem> coursesItemList) {
        this.mContext = mContext;
        this.coursesItemList = coursesItemList;
    }

    @Override
    public NewCoursesAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.courses_card, parent, false);

        return new NewCoursesAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final NewCoursesAdapter.MyViewHolder holder, int position) {
        final NewCourseItem album = coursesItemList.get(position);
