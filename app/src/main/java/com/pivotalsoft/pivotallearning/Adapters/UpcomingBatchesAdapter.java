...
public class UpcomingBatchesAdapter extends RecyclerView.Adapter<UpcomingBatchesAdapter.MyViewHolder> {

    private Context mContext;
    private List<UpcomingBatchItem> coursesItemList;
    ...
    public UpcomingBatchesAdapter(Context mContext, List<UpcomingBatchItem> coursesItemList) {
        this.mContext = mContext;
        this.coursesItemList = coursesItemList;
    }

    @Override
    public UpcomingBatchesAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.batch_card, parent, false);

        return new UpcomingBatchesAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final UpcomingBatchesAdapter.MyViewHolder holder, int position) {
        final UpcomingBatchItem album = coursesItemList.get(position);
