...
public class CoursesAdapter extends RecyclerView.Adapter<CoursesAdapter.MyViewHolder> {
    ...
    private List<CoursesItem> coursesItemList;
    ...
    public CoursesAdapter(Context mContext, List<CoursesItem> coursesItemList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        final CoursesItem album = coursesItemList.get(position);
